...
# without it a tarball build silently stamps the installed CONFIG package
# (LibreAgentConfigVersion.cmake, SameMajorVersion) with major version 0, which
# breaks every downstream `find_package(LibreAgent 5.x CONFIG)` at configure
# time. A DEVELOPMENT checkout has the opposite problem: `git describe` answers
# with the PREVIOUS release for the whole cycle, so between code freeze
# (VERSION bumped) and the tag the package this tree installs advertises the
# OLD major -- while the desktop, KDE and macOS backends already floor at the
...
if(NOT LIBREAGENT_VERSION_RESOLVED)
  if(NOT GITVERSION_FILE_VERSION STREQUAL "")
