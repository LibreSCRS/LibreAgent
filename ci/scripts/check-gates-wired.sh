...
#
# Why this exists: this repository shipped tools/dup-scan.py and
# tools/canonical-types.py, both self-tested, both green, and no workflow here
# named either until this gate arrived. Until then they measured nothing on
# every push.
#
