...
// translation of a per-request tsaUrl / visual override into LM's
// SigningRequest::Builder::tsaOverride / visualParams, which is otherwise only
// observable deep inside a real sign (requiring a working PKCS#11 module).
