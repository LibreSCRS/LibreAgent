...
int main()
{
    ...
    LAYOUT_BEGIN(CscaAnchorState)
    LAYOUT_MEMBER(anchors)
    LAYOUT_MEMBER(issuers)
    LAYOUT_MEMBER(replayRefusalActive)
    LAYOUT_MEMBER(signer)
    LAYOUT_MEMBER(signerPinned)
    LAYOUT_MEMBER(acceptedAt)
    LAYOUT_MEMBER(signedAt)
    LAYOUT_MEMBER(origin)
    LAYOUT_MEMBER(extra)
    LAYOUT_END()
